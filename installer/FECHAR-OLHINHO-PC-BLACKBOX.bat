...
echo O agente de monitoramento NAO sera parado.
echo.
...
echo.
echo Olhinho fechado. Se o icone ainda aparecer na bandeja, passe o mouse nele ou abra/feche a setinha de icones ocultos.
pause
